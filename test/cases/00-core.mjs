// =============================================================================
//  Draph core regression cases — the original suite.
//  Discovered and run by ../regression.mjs (the runner); it owns report()/exit.
//  See ../harness.mjs for what these can and cannot catch.
//
//  NOTE: this file is the legacy/core set. NEW tickets must add their OWN file
//  under test/cases/ (e.g. 70-waypoints.mjs) instead of appending here — that's
//  what stops parallel branches from colliding on one shared test file.
// =============================================================================
import { boot, mouse, pointer, key, check, group } from '../harness.mjs';
